...
The next applied step is a real-data validation example. That application should emphasize not only whether a threshold is crossed, but also when, where and under which predicted behavioural state the evidence accumulates. It should also report which diagnostics were pre-specified before validation and which were chosen exploratorily.
